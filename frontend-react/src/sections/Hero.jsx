...
const Hero = () => {
  ...
  return (
    <section className="relative flex justify-center items-center lg:py-28 py-20 overflow-hidden border-b border-slate-800 rounded-b-[100px] max-sm:border-0">
      <Element name="hero">
              ...
              <div className="w-full relative grid lg:grid-cols-3 lg:grid-rows-1 grid-rows-[auto_auto] max-md:grid-rows-[auto] gap-8 pt-10">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute top-[40%] max-sm:top-[30%] w-[600px] h-[600px] pointer-events-none before:absolute before:inset-0 before:bg-gradient-to-b before:from-indigo-500/25 before:via-indigo-500/5 before:via-25% before:to-indigo-500/0 before:to-75% before:rounded-full before:-z-50 max-sm:size-[400px]"
                  />
                  <div className="gradient-mask-b-40 relative flex justify-center z-40 max-sm:gradient-mask-b-30 overflow-visible w-[700px] h-[700px] max-sm:h-[400px]">
                    <img
                      src="/assets/images/david-hero-shot.png"
                      className="w-[120%] h-[120%] object-cover transition-opacity duration-300 p-[8rem_8rem_0_8rem]  max-sm:h-auto max-sm:p-[12rem] max-sm:pt-0 max-sm:absolute max-sm:top-[10%] max-sm:gradient-mask-b-30"
                      alt="HeroImage"
                    />
                  </div>
                </motion.div>
