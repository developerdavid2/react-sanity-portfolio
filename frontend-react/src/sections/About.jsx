  ...
  return (
    <section className="w-full relative flex items-center justify-center py-56 overflow-hidden flex-col text-center max-sm:py-10">
      <Element name="about">
        ...
        >
          <div className="max-md:container mx-auto px-4 md:px-8 max-md:max-w-3xl lg:px-0 ">
            ...
            {/* Bento Grid */}
            <div className="flex h-full w-full items-center justify-center pt-16 lg:mask-left-right">
